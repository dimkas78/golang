// Решается задача поиска максимального по размеру блока в прямоугольной решетке, раскрашенной разными цветами.
// Блоком считаются соседние ячейки одинакового цвета.
package main
